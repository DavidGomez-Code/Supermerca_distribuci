...
<html lang="es">
  <head>
    ...
    <title>SUPERMERCADOS LA ECONOMIA AYA/Productos</title>
      ...
      <!--Empieza el menú de navegación-->
        <nav class="barra-nave">
          ...
          <div class="titu-super">
            <h1 class="titulo">SUPERMERCADOS Y <br> DISTRIBUCIONES <br> ECONOMIA AYA</h1><br>
          </div>

          <div class="nues-esloga">
            <p class="eslogan">¡Compras inteligentes ahorros,<br> constantes!</p><br>
          </div>
    ...
    <!--Aqui finaliza el HEADER-->
      ...
      <main class="produc">
          <section class="festival-precios">
            <img src="http://drive.google.com/uc?export=view&id=1EQr5i5si2UHMQ33FLwWWps7A00di3Ti-" alt="titulo festival">
          </section>

          <section class="slider-todo">
            <img src="http://drive.google.com/uc?export=view&id=1lzF67R-QeDbRU7c-NQ2gM6EqK9cNrrsZ" class="image1" alt="image1">

            <img src="http://drive.google.com/uc?export=view&id=1HFTDv6xYKDIPoMH5Ex43_UdkSW5-hO4c" class="image2" alt="image2">

            <img src="http://drive.google.com/uc?export=view&id=1LccAeY5kYO_dpVG-gFYM8ZVcyhYuTSyQ" class="image3" alt="image3">

        <!--EL OTRO LADO DE LA PÁGINA-->
            <img src="http://drive.google.com/uc?export=view&id=1IZhqiKYcI-UHHCFNrJNRSEeYV7-CUPXb" class="imaga1" alt="image1">

            <img src="http://drive.google.com/uc?export=view&id=1vENYbPjiyOaVmOE_jFzrAw9-gM1d1uOk" class="imaga2" alt="image2">

            <img src="http://drive.google.com/uc?export=view&id=11BfHhFSSyfWoXjabGVGv9h530fHNfY6O" class="imaga3" alt="image3">

            <img src="http://drive.google.com/uc?export=view&id=1R4Zz37sqCyaOJWP2wyuhqPD5bblZeMk_" class="execep-imag" alt="image4">
          </section>
      </main>    
