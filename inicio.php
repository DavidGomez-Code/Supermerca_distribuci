...
<html lang="es">
  <head>
    ...
    <title>SUPERMERCADOS LA ECONOMIA AYA/Inicio</title>
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="Css/normalize.css">
    <link rel="shortcut icon" href="http://drive.google.com/uc?export=view&id=1SfSqPSFSHSOKbNPkrRsXGHPhFvOiQIEg"
    type="image/x-icon">
  ...
  ?>
    ...
    <!--Aqui finaliza el HEADER-->
      ...
      <main>
        <section class="pagi-ini">
          <div class="experiencia">
            <h2>¡La mejor experiencia de compra está con nosotros!</h2>
          </div>
          
          <div class="meses-aqui">
            <p>Todos los meses aquí son</p>
          </div>

          <div class="locura">
            <img src="http://drive.google.com/uc?export=view&id=1qoYdz0V7dZRwqFirGT1k4-0grxBwNE9j" alt="Precios de locura">
          </div>

          <div class="string-text">
            <p>Amplia selección de productos y una variedad de servicios,<br> como entregas a domicilio.</p>
          </div>

          <img src="http://drive.google.com/uc?export=view&id=1Bw_te4RUnof2Bo6yfnquskiDmrZtGaa_" class="grano" alt="productos granos">
          <img src="http://drive.google.com/uc?export=view&id=1STW264_CtBTjiQaiu4hD6_YXbv9Vtba3" class="Fab" alt="Jabón Fab">
          <img src="http://drive.google.com/uc?export=view&id=1PyPku6fz-gbZ4jTfD-2TYZdbOTnD10Z4" class="Ariel" alt="Jabón Ariel">  
          <img src="http://drive.google.com/uc?export=view&id=1a9anAbL_kbaikfzVc4bHVJgpSmCpNMEE" class="Shoul" alt="Shampoo head& shoulders">
          <img src="http://drive.google.com/uc?export=view&id=1-ajSglrFXFcog49B80ObQFHSWBgalDVJ" class="Papel" alt="Papel Familia">
          <img src="http://drive.google.com/uc?export=view&id=1FBPkyGDbDOGordrbiFSafj8PpssaCITu" class="Crema" alt="Crema Colgate">  
          <img src="http://drive.google.com/uc?export=view&id=1V8SdqHmFm9SpecDG4Ek8mLHIZ72crZA4" class="plasa" alt="Productos Plaza">

      <!--La Sección del otro lado-->
          <div class="Mas-plaza">
            <p>Más de nuestros productos <br>(Frutas y Verduras)</p>
          </div>

          <div class="calidad">
            <p>Cuidadosamente seleccionadas de <br>proveedores locales y regionales para <br>garantizar su frescura y calidad.</p>
          </div>
        </section>      
      </main>
