      ...
      <!--Empieza el menú de navegación-->
        <nav class="barra-nave">
          ...
          <ul class="nav-barra">
            ...
            <li class="sesion"><a class="regis-titu" href="login.php">Inicio Sesión</a></li>
        </ul>
      </nav>
    </header>
    <!--Aqui finaliza el HEADER-->

    <!--El (login INICIO DE SESIÓN) de la página-->
    <main>
      <section class="login_register">
        <div class="sesion-inicio">
          <form class="formu" action="validar.php" method="post">
            <div class="useers">
              <img src="http://drive.google.com/uc?export=view&id=1d8D6LWsoW362z2oQyr__KNRAy8Ev0-xM" alt="usuario">
            </div>
            <h1 class="registra">BIENVENIDO</h1>
            <p class="realiza">¡Inicia sesión y podrás realizar tus pedidos!</p><br>
          ...
          <?php
          // Mostrar mensaje de error si se recibe el parámetro "error" en la URL
          if(isset($_GET['error']) && $_GET['error'] == 1) {
          echo "<p style='color:red;'>Usuario o Contraseña incorrectos.</p>";
          }
          ?>          
            <p class="pedidos">¿No tienes cuenta? Entra Aquí <a class="flat" href="login.php">Registrate</a></p><br>
              <div>
                <a href="inicio.php"><input class="sesiones" type="submit" value="Iniciar sesión"></a>  
